...
import com.mianmianshi.platform.model.dto.user.*;
...
import static com.mianmianshi.platform.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Boolean> editUser(@RequestBody UserEditRequest userEditRequest, HttpServletRequest request) {
        ...
        // 如果是用户编辑自己，强制设置 ID 为当前用�?ID（防止越权修改）
