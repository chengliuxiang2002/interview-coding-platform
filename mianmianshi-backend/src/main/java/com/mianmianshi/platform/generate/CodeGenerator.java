package com.mianmianshi.platform.generate;
...
public class CodeGenerator {
    ...
    /**
     * 用法：修改生成参数和生成路径，注释掉不需要的生成逻辑，然后运行即�?
     *
     * @param args
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        // 指定生成参数
        String packageName = "com.mianmianshi.platform";
