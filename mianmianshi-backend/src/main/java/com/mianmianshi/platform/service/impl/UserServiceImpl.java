...
import com.mianmianshi.platform.constant.RedisConstant;
import com.mianmianshi.platform.exception.BusinessException;
import com.mianmianshi.platform.mapper.UserMapper;
import com.mianmianshi.platform.model.dto.user.UserQueryRequest;
import com.mianmianshi.platform.model.entity.User;
import com.mianmianshi.platform.model.enums.UserRoleEnum;
import com.mianmianshi.platform.model.vo.LoginUserVO;
import com.mianmianshi.platform.model.vo.UserVO;
import com.mianmianshi.platform.satoken.DeviceUtils;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "mianmianshi";
...
//        request.getSession().removeAttribute(USER_LOGIN_STATE);
    ...
    public List<Integer> getUserSignInRecord(long userId, Integer year) {
        ...
        // 获取 Redis �?BitMap
        RBitSet signInBitSet = redissonClient.getBitSet(key);
        // 加载 BitSet 到内存中，避免后续读取时发送多次请�?
        BitSet bitSet = signInBitSet.asBitSet();
        // 统计签到的日�?
        List<Integer> dayList = new ArrayList<>();
        // 从索�?0 开始查找下一个被设置�?1 的位
